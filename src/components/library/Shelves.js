        ...
        <>
            ...
            <ShelvesContainer>
                <div className='shelves'>
                    <h1>My Shelves</h1>
                    <StatusShelfCarousel title='My books' display='carousel' bookList={userBooks} link='/shelf/mybooks' breadcrumbs={[{ label: 'My shelves', path: '/myshelves' }, { label: 'My books', path: '/shelf/mybooks' }, { label: "Book details", path: null }]} />
                    <StatusShelfCarousel title='Favorites' display='carousel' bookList={favorites} link='/shelf/favorites' breadcrumbs={[{ label: 'My shelves', path: '/myshelves' }, { label: 'Favorites', path: '/shelf/favorites' }, { label: "Book details", path: null }]} />
                    <StatusShelfCarousel title='To be read' display='carousel' bookList={toBeRead} link='/shelf/toberead' breadcrumbs={[{ label: 'My shelves', path: '/myshelves' }, { label: 'To be read', path: '/shelf/toberead' }, { label: "Book details", path: null }]} />
