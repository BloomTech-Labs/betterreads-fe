...
const BookCard = props => {
	...
	return (
		<BookCardContainer thumbnail={props.book.thumbnail || props.book.smallThumbnail} source={props.source} con-width={props.source === 'recommendation' ? '88px' : '100%'} data-library={inLibrary} data-book={props.book.googleId}>
